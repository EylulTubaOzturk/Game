...
namespace GameProject
{
    class Program
    {
        ...
        {
            IPlayer player1 = new OldPlayer() { TcNo = "1", BirthYear = 1999, PlayerName = "Eylül", PlayerSurname = "Öztürk", MembershipYear = 2 };
            IPlayer player2 = new OldPlayer() { TcNo = "2", BirthYear = 1985, PlayerName = "Ahmet", PlayerSurname = "Güçlü", MembershipYear = 20 };
